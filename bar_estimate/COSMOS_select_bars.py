...
max_bar_ids = np.where((z >2.5) & (p_bar>0.5) & (p_feature>0.5) & (p_edgeon<0.5) & (q>0.5))[0]
print(max(m150))
...
max_bar_image_F200W.save("/n03data/huertas/COSMOS-Web/zoobot/bar_candidates/bars_f444w_zgt3.jpg")
