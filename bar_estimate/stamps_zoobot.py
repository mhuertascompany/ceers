...
def select_stamps_and_plot(merge,zbin,imdir,outdir): 
    ...
    i=0
    for bar_id,p_feature,p_bar,zr in zip(bars_hz.id_str.values,bars_hz.p_feature_mean.values,bars_hz.p_spiral_mean.values,bars_hz.LP_zfinal):
    ...
    max_bar_image.save(os.path.join(outdir,f'spiral_{filter}_{zlow}_{zhigh}.jpg'))
...
for zb in z_bins:
    select_stamps_and_plot(cat,zb,'/n03data/huertas/COSMOS-Web/zoobot/stamps/','/n03data/huertas/COSMOS-Web/zoobot/spiral_candidates')
