...
for FILTER in FILTERS:
    ...
    for i in range(NUM_MODELS):
        pred_path = os.path.join(cat_dir, f'bars_COSMOS_3.1_{FILTER}_m27_nano.csv')
    ...
    # Save results to CSV
    output_path = os.path.join(cat_dir, f'gzoo_COSMOS_3.1_{FILTER}_nano_m27_sampling.csv')
