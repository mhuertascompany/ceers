...
with PdfPages(data_path+'figures/reg_CEERS_irr_CANDELS_f200w.pdf') as pdf_ceers,PdfPages(data_path+'figures/reg_CEERS_irr_CANDELS_f160w.pdf') as pdf_candels:
    for zlow,zup in zip(zbins[:-1],zbins[1:]):
        sel = candels_ceers.query('(morph_flag_f200w==1 or morph_flag_f200w==3 or morph_flag_f200w==0) and (morph_CANDELS==2) and zfit_50>'+str(0)+' and zfit_50<'+str(2))
