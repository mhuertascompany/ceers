...
morph_class = ['late','early','irr', 'disk', 'sph', 'db','reg','comp','all']
...
smf_files = ["smf_morph_3.1_allerrors_nocompactphys_noqsos_nolrds_noXray","smf_morph_3.1_allerrors_nocompactphys_noqsos_nolrds_noXray_SF","smf_morph_3.1_allerrors_nocompactphys_noqsos_nolrds_noXray_Q"]
