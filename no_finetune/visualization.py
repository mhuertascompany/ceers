...
repr_loc = 'no_finetune/repr_results/F200W_representations.hdf5'
...
plt.savefig(f'no_finetune/repr_results/F200W_umap_mag_coded.png')
...
for i in range(n1):
    for j in range(n2):
        ...
        if np.any(in_region):
            ...
            tn_loc = f'images/demo_F200W/F200W_{tn_id}.jpg'
...
plt.ylabel('UMAP 2')
plt.legend()
plt.savefig('no_finetune/repr_results/F200W_thumbnails.png')
